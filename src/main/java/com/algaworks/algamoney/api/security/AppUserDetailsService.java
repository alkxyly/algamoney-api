...
public class AppUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		Optional<Usuario> usuarioOp = usuarioReposity.findByEmail(email);
		Usuario usuario = usuarioOp.orElseThrow(() -> new UsernameNotFoundException("Usuário e/ou senha incorreto"));
